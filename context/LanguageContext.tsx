...
const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    'actions.feasibility': 'Create Feasibility',
    ...
    'metrics.annual_savings': 'Annual Savings',
    'metrics.coverage': 'coverage',
    'metrics.coverage_title': 'Consumption Coverage',
    ...
    'chart.empty_title': 'Production chart is waiting for a valid layout',
    'chart.user_explainer': 'This chart shows the relative in-day power profile; real output changes with site, temperature, shading, and operations.',
    ...
    'notices.report_generated': 'Feasibility PDF created successfully.',
    'notices.report_failed': 'Feasibility PDF could not be created.',
  },
  tr: {
    ...
    'actions.feasibility': 'Fizibilite Oluştur',
    ...
    'metrics.annual_savings': 'Yıllık Tasarruf',
    'metrics.coverage': 'karşılama',
    'metrics.coverage_title': 'Tüketim Karşılama',
    'metrics.pending': 'Bekleniyor',
    ...
    'chart.empty_title': 'Üretim grafiği geçerli bir yerleşim bekliyor',
    'chart.user_explainer': 'Bu grafik gün içi göreceli güç profilini gösterir; gerçek üretim saha, sıcaklık, gölge ve işletme koşullarına göre değişebilir.',
    ...
    'notices.report_generated': 'Fizibilite PDF basariyla olusturuldu.',
    'notices.report_failed': 'Fizibilite PDF olusturulamadi.',
  },
};
